...
#define MY_O_B side="West"; commander="fow_jap_Men";
#define MY_O_I side="Resistance"; commander="NATOMen";
...
class CfgORBAT {
    class b {
        MY_O_B_BT
        description="Hardened fighters that will never surrender.";
        text="Imperial Japanese Army Brigade";
        textShort="IJA";
        ...
        class 1 {
            ...
            class 3 { MY_IF_3 id=3; MY_O_B_C_INF };
        ...
        class 2 {
            ...
            class 7 { MY_IF_7 id=7; MY_O_B_C_INF };
    ...
    class i {
        ...
        description="Combined arms force optimized for amphibious operations.";
