...
class CfgORBAT {
    class b {
        MY_O_B_BT
        description="German forces attempting to seize Egypt, the Suez Canal, and Persian oil fields.";
    ...
    class i {
        ...
        description="British forces tasked with ending the Axis threat to Egypt.";
        text="Royal Chillsim Combined Brigade";
        ...
        class 4 {
            ...
            id=4;
            text="%1 %2 %3";
            class 11 { MY_IF_11 id=11; MY_O_I_C_SUP };
