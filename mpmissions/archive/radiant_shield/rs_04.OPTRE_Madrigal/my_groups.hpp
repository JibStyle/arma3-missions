    ...
    class East {
        class my_o_mixed {
            class Infantry {
                ...
                class my_g_32 {MY_G_O_WBK_MIXED_FIRETEAM_MINOR};
                class my_g_33 {MY_G_O_WBK_MIXED_FIRETEAM_MINOR};
                class my_g_34 {MY_G_O_WBK_MIXED_FIRETEAM_MINOR};
                class my_g_35 {MY_G_O_WBK_MIXED_FIRETEAM_MINOR};
                class my_g_36 {MY_G_O_WBK_MIXED_FIRETEAM_ULTRA};
                class my_g_37 {MY_G_O_WBK_MIXED_FIRETEAM_OFFICER};
                ...
                class my_g_43 {MY_G_O_WBK_ELITE_FIRETEAM_MAJOR};
                class my_g_44 {MY_G_O_WBK_ELITE_FIRETEAM_ULTRA};
                class my_g_45 {MY_G_O_WBK_ELITE_FIRETEAM_ZEALOT};
                class my_g_46 {MY_G_O_WBK_ELITE_FIRETEAM_MARSHALL};
            };
            class Motorized {
            ...
            class SpecOps {
                ...
                class my_g_60 {MY_G_O_WBK_ELITE_FIRETEAM_SPEC};
            };
        };
        class my_o_optre {
            class Infantry {
                class my_g_61 {MY_G_O_OPTRE_JACKAL_SECTION};
                class my_g_62 {MY_G_O_OPTRE_JACKAL_PATROL};
                class my_g_63 {MY_G_O_OPTRE_JACKAL_SNIPER_TEAM};
                class my_g_64 {MY_G_O_OPTRE_JACKAL_RECON_TEAM};
                class my_g_65 {MY_G_O_OPTRE_ELITE_SECTION};
                class my_g_66 {MY_G_O_OPTRE_ELITE_AA_SECTION};
                class my_g_67 {MY_G_O_OPTRE_ELITE_AT_SECTION};
                class my_g_68 {MY_G_O_OPTRE_ELITE_PATROL};
                class my_g_69 {MY_G_O_OPTRE_ELITE_SNIPER_TEAM};
                class my_g_70 {MY_G_O_OPTRE_ELITE_RECON_TEAM};
                class my_g_71 {MY_G_O_OPTRE_ELITE_COMMAND_TEAM};
                class my_g_72 {MY_G_O_OPTRE_ELITE_COMMAND_SQUAD};
                class my_g_73 {MY_G_O_OPTRE_MIXED_LEVY};
                class my_g_74 {MY_G_O_OPTRE_MIXED_SECTION};
                class my_g_75 {MY_G_O_OPTRE_MIXED_RECON_TEAM};
                class my_g_76 {MY_G_O_OPTRE_MIXED_COMMAND_TEAM};
                class my_g_77 {MY_G_O_OPTRE_MIXED_FILE};
            };
            class Motorized {
                class my_g_78 {MY_G_O_OPTRE_SPECTRE_MIXED};
                class my_g_79 {MY_G_O_OPTRE_SPECTRE_ELITE};
            };
            class Mechanized {
                class my_g_80 {MY_G_O_OPTRE_GHOST_PAIR};
                class my_g_81 {MY_G_O_OPTRE_GHOST_HEAVY};
                class my_g_82 {MY_G_O_OPTRE_SPECTRE_ARMED};
            };
            class Armored {
                class my_g_83 {MY_G_O_OPTRE_WRAITH};
            };
            class SpecOps {
                class my_g_84 {MY_G_O_OPTRE_MIXED_SPEC_OPS_FILE};
            };
        };
        class my_o_wbk {
            class Infantry {
                class my_g_85 {MY_G_O_WBK_GRUNT_SENTRY_MINOR};
                class my_g_86 {MY_G_O_WBK_GRUNT_SENTRY_ULTRA};
                class my_g_87 {MY_G_O_WBK_GRUNT_FIRETEAM_LIGHT};
                class my_g_88 {MY_G_O_WBK_GRUNT_FIRETEAM_MEDIUM};
                class my_g_89 {MY_G_O_WBK_GRUNT_FIRETEAM_HEAVY};
                class my_g_90 {MY_G_O_WBK_ELITE_SENTRY_MINOR};
                class my_g_91 {MY_G_O_WBK_ELITE_SENTRY_HONOR};
                class my_g_92 {MY_G_O_WBK_ELITE_SENTRY_ULTRA};
                class my_g_93 {MY_G_O_WBK_ELITE_FIRETEAM_MAJOR};
                class my_g_94 {MY_G_O_WBK_ELITE_FIRETEAM_OFFICER};
                class my_g_95 {MY_G_O_WBK_ELITE_FIRETEAM_ULTRA};
                class my_g_96 {MY_G_O_WBK_ELITE_FIRETEAM_ZEALOT};
                class my_g_97 {MY_G_O_WBK_ELITE_FIRETEAM_MARSHALL};
                class my_g_98 {MY_G_O_WBK_MIXED_FIRETEAM_MINOR};
                class my_g_99 {MY_G_O_WBK_MIXED_FIRETEAM_OFFICER};
                class my_g_100 {MY_G_O_WBK_MIXED_FIRETEAM_ULTRA};
            };
            class Motorized {
                class my_g_101 {MY_G_O_WBK_HUNTER_SENTRY_BLUE};
                class my_g_102 {MY_G_O_WBK_MIXED_HUNTER_FIRETEAM_BLUE};
            };
            class Mechanized {
                class my_g_103 {MY_G_O_WBK_HUNTER_SENTRY_GOLD};
                class my_g_104 {MY_G_O_WBK_HUNTER_SENTRY_RED};
            };
            class Armored {
                class my_g_105 {MY_G_O_WBK_MIXED_HUNTER_FIRETEAM_GOLD};
                class my_g_106 {MY_G_O_WBK_MIXED_HUNTER_FIRETEAM_RED};
                class my_g_107 {MY_G_O_WBK_MIXED_HUNTER_FIRETEAM_SPEC};
            };
            class SpecOps {
                class my_g_108 {MY_G_O_WBK_ELITE_SENTRY_SPEC};
                class my_g_109 {MY_G_O_WBK_ELITE_FIRETEAM_SPEC};
            };
        };
    };
    class West {
