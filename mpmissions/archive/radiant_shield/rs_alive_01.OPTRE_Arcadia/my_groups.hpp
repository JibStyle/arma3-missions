...
class CfgGroups {
    class East {
        ...
        class my_o_mixed {
            class Infantry {
                class my_g_49 {MY_G_O_OPTRE_JACKAL_SECTION};
                class my_g_50 {MY_G_O_OPTRE_JACKAL_PATROL};
                class my_g_51 {MY_G_O_OPTRE_JACKAL_SNIPER_TEAM};
                class my_g_52 {MY_G_O_OPTRE_JACKAL_RECON_TEAM};
                class my_g_53 {MY_G_O_OPTRE_ELITE_SECTION};
                class my_g_54 {MY_G_O_OPTRE_ELITE_AA_SECTION};
                class my_g_55 {MY_G_O_OPTRE_ELITE_AT_SECTION};
                class my_g_56 {MY_G_O_OPTRE_ELITE_PATROL};
                class my_g_57 {MY_G_O_OPTRE_ELITE_SNIPER_TEAM};
                class my_g_58 {MY_G_O_OPTRE_ELITE_RECON_TEAM};
                class my_g_59 {MY_G_O_OPTRE_ELITE_COMMAND_TEAM};
                class my_g_60 {MY_G_O_OPTRE_ELITE_COMMAND_SQUAD};
                class my_g_61 {MY_G_O_OPTRE_MIXED_LEVY};
                class my_g_62 {MY_G_O_OPTRE_MIXED_SECTION};
                class my_g_63 {MY_G_O_OPTRE_MIXED_RECON_TEAM};
                class my_g_64 {MY_G_O_OPTRE_MIXED_COMMAND_TEAM};
                class my_g_65 {MY_G_O_OPTRE_MIXED_FILE};
                class my_g_66 {MY_G_O_WBK_GRUNT_SENTRY_MINOR};
                class my_g_67 {MY_G_O_WBK_GRUNT_SENTRY_ULTRA};
                class my_g_68 {MY_G_O_WBK_GRUNT_FIRETEAM_LIGHT};
                class my_g_69 {MY_G_O_WBK_GRUNT_FIRETEAM_MEDIUM};
                class my_g_70 {MY_G_O_WBK_GRUNT_FIRETEAM_HEAVY};
                class my_g_71 {MY_G_O_WBK_ELITE_SENTRY_MINOR};
                class my_g_72 {MY_G_O_WBK_ELITE_SENTRY_HONOR};
                class my_g_73 {MY_G_O_WBK_ELITE_SENTRY_ULTRA};
                class my_g_74 {MY_G_O_WBK_ELITE_FIRETEAM_MAJOR};
                class my_g_75 {MY_G_O_WBK_ELITE_FIRETEAM_OFFICER};
                class my_g_76 {MY_G_O_WBK_ELITE_FIRETEAM_ULTRA};
                class my_g_77 {MY_G_O_WBK_ELITE_FIRETEAM_ZEALOT};
                class my_g_78 {MY_G_O_WBK_ELITE_FIRETEAM_MARSHALL};
                class my_g_79 {MY_G_O_WBK_MIXED_FIRETEAM_MINOR};
                class my_g_80 {MY_G_O_WBK_MIXED_FIRETEAM_OFFICER};
                class my_g_81 {MY_G_O_WBK_MIXED_FIRETEAM_ULTRA};
            };
            class Motorized {
                class my_g_82 {MY_G_O_OPTRE_SPECTRE_MIXED};
                class my_g_83 {MY_G_O_OPTRE_SPECTRE_ELITE};
            };
            class Mechanized {
                class my_g_84 {MY_G_O_OPTRE_GHOST_PAIR};
                class my_g_85 {MY_G_O_OPTRE_GHOST_HEAVY};
                class my_g_86 {MY_G_O_OPTRE_SPECTRE_ARMED};
            };
            class Armored {
                class my_g_87 {MY_G_O_OPTRE_WRAITH};
                class my_g_88 {MY_G_O_OPTRE_WRAITH};
                class my_g_89 {MY_G_O_OPTRE_WRAITH};
                class my_g_90 {MY_G_O_OPTRE_WRAITH};
                class my_g_91 {MY_G_O_OPTRE_WRAITH};
                class my_g_92 {MY_G_O_WBK_MIXED_HUNTER_FIRETEAM_GOLD};
                class my_g_93 {MY_G_O_WBK_MIXED_HUNTER_FIRETEAM_RED};
                class my_g_94 {MY_G_O_WBK_MIXED_HUNTER_FIRETEAM_SPEC};
                class my_g_95 {MY_G_O_WBK_HUNTER_SENTRY_BLUE};
                class my_g_96 {MY_G_O_WBK_MIXED_HUNTER_FIRETEAM_BLUE};
                class my_g_97 {MY_G_O_WBK_HUNTER_SENTRY_GOLD};
                class my_g_98 {MY_G_O_WBK_HUNTER_SENTRY_RED};
            };
            class SpecOps {
                class my_g_99 {MY_G_O_OPTRE_MIXED_SPEC_OPS_FILE};
                class my_g_100 {MY_G_O_WBK_ELITE_SENTRY_SPEC};
                class my_g_101 {MY_G_O_WBK_ELITE_FIRETEAM_SPEC};
            };
        };
    };
    class West {
        class my_b_army_wdl {
            class Infantry {
                class my_g_102 {MY_G_B_ARMY_WDL_SENTRY};
                class my_g_103 {MY_G_B_ARMY_WDL_FIRETEAM};
                class my_g_104 {MY_G_B_ARMY_WDL_SQUAD};
                class my_g_105 {MY_G_B_ARMY_WDL_WEAPONS_SQUAD};
            };
            class Motorized {
                class my_g_106 {MY_G_B_ARMY_WDL_HOG_MG};
                class my_g_107 {MY_G_B_ARMY_WDL_HOG_ROCKET};
                class my_g_108 {MY_G_B_ARMY_WDL_HOG_GAUSS};
                class my_g_109 {MY_G_B_ARMY_WDL_HOG_AA};
            };
            class Mechanized {
                class my_g_110 {MY_G_B_ARMY_WDL_WHEELED_IFV};
                class my_g_111 {MY_G_B_ARMY_WDL_WHEELED_MGS};
                class my_g_112 {MY_G_B_ARMY_WDL_TRACKED_IFV};
            };
            class Armored {
                class my_g_113 {MY_G_B_ARMY_WDL_SCORPION};
            };
            class SpecOps {
                class my_g_114 {MY_G_B_ARMY_WDL_SNIPER_TEAM};
                class my_g_115 {MY_G_B_ARMY_WDL_COMMAND_TEAM};
            };
        };
        class my_b_army_oli {
            class Infantry {
                class my_g_116 {MY_G_B_ARMY_OLI_SENTRY};
                class my_g_117 {MY_G_B_ARMY_OLI_FIRETEAM};
                class my_g_118 {MY_G_B_ARMY_OLI_SQUAD};
                class my_g_119 {MY_G_B_ARMY_OLI_WEAPONS_SQUAD};
            };
            class Motorized {
                class my_g_120 {MY_G_B_ARMY_OLI_HOG_MG};
                class my_g_121 {MY_G_B_ARMY_OLI_HOG_ROCKET};
                class my_g_122 {MY_G_B_ARMY_OLI_HOG_GAUSS};
                class my_g_123 {MY_G_B_ARMY_OLI_HOG_AA};
            };
            class Mechanized {
                class my_g_124 {MY_G_B_ARMY_OLI_WHEELED_IFV};
                class my_g_125 {MY_G_B_ARMY_OLI_WHEELED_MGS};
                class my_g_126 {MY_G_B_ARMY_OLI_TRACKED_IFV};
            };
            class Armored {
                class my_g_127 {MY_G_B_ARMY_OLI_SCORPION};
            };
            class SpecOps {
                class my_g_128 {MY_G_B_ARMY_OLI_SNIPER_TEAM};
                class my_g_129 {MY_G_B_ARMY_OLI_COMMAND_TEAM};
            };
        };
        class my_b_army_des {
            class Infantry {
                class my_g_130 {MY_G_B_ARMY_DES_SENTRY};
                class my_g_131 {MY_G_B_ARMY_DES_FIRETEAM};
                class my_g_132 {MY_G_B_ARMY_DES_SQUAD};
                class my_g_133 {MY_G_B_ARMY_DES_WEAPONS_SQUAD};
            };
            class Motorized {
                class my_g_134 {MY_G_B_ARMY_DES_HOG_MG};
                class my_g_135 {MY_G_B_ARMY_DES_HOG_ROCKET};
                class my_g_136 {MY_G_B_ARMY_DES_HOG_GAUSS};
                class my_g_137 {MY_G_B_ARMY_DES_HOG_AA};
            };
            class Mechanized {
                class my_g_138 {MY_G_B_ARMY_DES_WHEELED_IFV};
                class my_g_139 {MY_G_B_ARMY_DES_WHEELED_MGS};
                class my_g_140 {MY_G_B_ARMY_DES_TRACKED_IFV};
            };
            class Armored {
                class my_g_141 {MY_G_B_ARMY_DES_SCORPION};
            };
            class SpecOps {
                class my_g_142 {MY_G_B_ARMY_DES_SNIPER_TEAM};
                class my_g_143 {MY_G_B_ARMY_DES_COMMAND_TEAM};
            };
        };
        class my_b_army_urb {
            class Infantry {
                class my_g_144 {MY_G_B_ARMY_URB_SENTRY};
                class my_g_145 {MY_G_B_ARMY_URB_FIRETEAM};
                class my_g_146 {MY_G_B_ARMY_URB_SQUAD};
                class my_g_147 {MY_G_B_ARMY_URB_WEAPONS_SQUAD};
            };
            class Motorized {
                class my_g_148 {MY_G_B_ARMY_URB_HOG_MG};
                class my_g_149 {MY_G_B_ARMY_URB_HOG_ROCKET};
                class my_g_150 {MY_G_B_ARMY_URB_HOG_GAUSS};
                class my_g_151 {MY_G_B_ARMY_URB_HOG_AA};
            };
            class Mechanized {
                class my_g_152 {MY_G_B_ARMY_URB_WHEELED_IFV};
                class my_g_153 {MY_G_B_ARMY_URB_WHEELED_MGS};
                class my_g_154 {MY_G_B_ARMY_URB_TRACKED_IFV};
            };
            class Armored {
                class my_g_155 {MY_G_B_ARMY_URB_SCORPION};
            };
            class SpecOps {
                class my_g_156 {MY_G_B_ARMY_URB_SNIPER_TEAM};
                class my_g_157 {MY_G_B_ARMY_URB_COMMAND_TEAM};
            };
        };
        class my_b_army_tro {
            class Infantry {
                class my_g_158 {MY_G_B_ARMY_TRO_SENTRY};
                class my_g_159 {MY_G_B_ARMY_TRO_FIRETEAM};
                class my_g_160 {MY_G_B_ARMY_TRO_SQUAD};
                class my_g_161 {MY_G_B_ARMY_TRO_WEAPONS_SQUAD};
            };
            class Motorized {
                class my_g_162 {MY_G_B_ARMY_TRO_HOG_MG};
                class my_g_163 {MY_G_B_ARMY_TRO_HOG_ROCKET};
                class my_g_164 {MY_G_B_ARMY_TRO_HOG_GAUSS};
                class my_g_165 {MY_G_B_ARMY_TRO_HOG_AA};
            };
            class Mechanized {
                class my_g_166 {MY_G_B_ARMY_TRO_WHEELED_IFV};
                class my_g_167 {MY_G_B_ARMY_TRO_WHEELED_MGS};
                class my_g_168 {MY_G_B_ARMY_TRO_TRACKED_IFV};
            };
            class Armored {
                class my_g_169 {MY_G_B_ARMY_TRO_SCORPION};
            };
            class SpecOps {
                class my_g_170 {MY_G_B_ARMY_TRO_SNIPER_TEAM};
                class my_g_171 {MY_G_B_ARMY_TRO_COMMAND_TEAM};
            };
        };
        class my_b_army_sno {
            class Infantry {
                class my_g_172 {MY_G_B_ARMY_SNO_SENTRY};
                class my_g_173 {MY_G_B_ARMY_SNO_FIRETEAM};
                class my_g_174 {MY_G_B_ARMY_SNO_SQUAD};
                class my_g_175 {MY_G_B_ARMY_SNO_WEAPONS_SQUAD};
            };
            class Motorized {
                class my_g_176 {MY_G_B_ARMY_SNO_HOG_MG};
                class my_g_177 {MY_G_B_ARMY_SNO_HOG_ROCKET};
                class my_g_178 {MY_G_B_ARMY_SNO_HOG_GAUSS};
                class my_g_179 {MY_G_B_ARMY_SNO_HOG_AA};
            };
            class Mechanized {
                class my_g_180 {MY_G_B_ARMY_SNO_WHEELED_IFV};
                class my_g_181 {MY_G_B_ARMY_SNO_WHEELED_MGS};
                class my_g_182 {MY_G_B_ARMY_SNO_TRACKED_IFV};
            };
            class Armored {
                class my_g_183 {MY_G_B_ARMY_SNO_SCORPION};
            };
            class SpecOps {
                class my_g_184 {MY_G_B_ARMY_SNO_SNIPER_TEAM};
                class my_g_185 {MY_G_B_ARMY_SNO_COMMAND_TEAM};
            };
        };
        class my_b_marine {
            class Infantry {
                class my_g_186 {MY_G_B_MARINE_SENTRY};
                class my_g_187 {MY_G_B_MARINE_FIRETEAM};
                class my_g_188 {MY_G_B_MARINE_SQUAD};
                class my_g_189 {MY_G_B_MARINE_WEAPONS_SQUAD};
            };
            class Motorized {
                class my_g_190 {MY_G_B_MARINE_HOG_MG};
                class my_g_191 {MY_G_B_MARINE_HOG_ROCKET};
                class my_g_192 {MY_G_B_MARINE_HOG_GAUSS};
                class my_g_193 {MY_G_B_MARINE_HOG_AA};
            };
            class Mechanized {
                class my_g_194 {MY_G_B_MARINE_WHEELED_IFV};
                class my_g_195 {MY_G_B_MARINE_WHEELED_MGS};
                class my_g_196 {MY_G_B_MARINE_TRACKED_IFV};
            };
            class Armored {
                class my_g_197 {MY_G_B_MARINE_SCORPION};
            };
            class SpecOps {
                class my_g_198 {MY_G_B_MARINE_SNIPER_TEAM};
                class my_g_199 {MY_G_B_MARINE_COMMAND_TEAM};
            };
        };
        class my_b_odst {
            class Infantry {
                class my_g_200 {MY_G_B_ODST_TEAM};
                class my_g_201 {MY_G_B_ODST_SCOUT_TEAM};
                class my_g_202 {MY_G_B_ODST_DEMO_TEAM};
            };
            class Motorized {
            };
            class Mechanized {
            ...
            class SpecOps {
                class my_g_203 {MY_G_B_ODST_SNIPER_TEAM};
            };
        };
    };
    class Indep {
        class my_i_flood {
            class Infantry {
                class my_g_204 {MY_G_I_FLOOD_COMBAT};
                class my_g_205 {MY_G_I_FLOOD_HUMAN};
                class my_g_206 {MY_G_I_FLOOD_ELITE};
            };
            class Motorized {
            };
            class Mechanized {
            ...
            class SpecOps {
                class my_g_207 {MY_G_I_FLOOD_INFECTION};
            };
        };
    };
};
