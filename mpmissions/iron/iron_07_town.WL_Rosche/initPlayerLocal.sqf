...
- Delta: Infantry squad.<br/>
- Warthog: Transport trucks."
    ]
];
player createDiaryRecord [
    "Diary",
    [
        ...
        "1. Regroup at Checkpoint Whiskey.<br/>
2. Assault Soviet held town."
    ]
];
player createDiaryRecord [
    "Diary",
    [
        ...
        "Assault and hold the Soviet occupied town."
    ]
];
player createDiaryRecord [
    "Diary",
    [
        ...
        "The Soviets hold a town on a vital crossroad for moving supplies through the area. In fact, this location was used to stage their initial assault on our airfield. Command wants us to seize this town as it is a key hub for logistics and troop movement. We expect the Russians to occupy buildings and several bunkers in the town. There may be patrols around the perimeter. It is likely the enemy will call reinforcements once they know we are here, so get ready for a fight!"
    ]
];
uiSleep 1;
