            ...
            [
                ...
                [
                    ...
                    [
                        "AO 3",
                        [
                            ["10", toString {[["3"], 10] remoteExec ["jib_misc_ao", 2]}],
                            ["20", toString {[["3"], 20] remoteExec ["jib_misc_ao", 2]}],
                            ["30", toString {[["3"], 30] remoteExec ["jib_misc_ao", 2]}],
                            ["40", toString {[["3"], 40] remoteExec ["jib_misc_ao", 2]}],
                            ["50", toString {[["3"], 50] remoteExec ["jib_misc_ao", 2]}],
                            ["60", toString {[["3"], 60] remoteExec ["jib_misc_ao", 2]}],
                            ["70", toString {[["3"], 70] remoteExec ["jib_misc_ao", 2]}],
                            ["80", toString {[["3"], 80] remoteExec ["jib_misc_ao", 2]}],
                            ["90", toString {[["3"], 90] remoteExec ["jib_misc_ao", 2]}]
                        ]
                    ]
                ],
                [
                    ...
                    [
                        ...
                        [
                            ["Town Inf", toString {
                                [my_e_town_inf] remoteExec ["jib_emitter_single", 2]
                            }, "1", true],
                            ["Town Vic", toString {
